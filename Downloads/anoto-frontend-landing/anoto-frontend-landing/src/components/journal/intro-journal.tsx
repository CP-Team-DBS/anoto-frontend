...
export default function IntroJournal() {
  return (
    <div className="relative flex flex-col min-h-screen bg-[#F7F5EE] text-[#0E103D] font-sans overflow-hidden">
      <Image
      ...
      <Container className="relative z-10 flex-1 flex items-center justify-center">
        <div className="w-full max-w-4xl text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Lagi Ngerasa <br />Apa Hari Ini?</h1>
          <p className="text-[#0E103D]/80 text-lg max-w-2xl mx-auto mb-10">
            Tulis apa yang kamu rasain. Kita bantu lihat pola emosimu dan <br /> kasih insight biar hatimu lebih lega.
          </p>
