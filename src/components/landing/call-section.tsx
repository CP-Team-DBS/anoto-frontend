...
const SectionHeading = () => (
  <>
    ...
    <motion.p
      ...
      className="text-base text-white mt-4 max-w-2xl text-center md:text-start md:text-xl"
    >
...
const FeatureCard = ({
  ...
  return (
    ...
    >
      <Card
        className={`${cardProps.className} flex flex-col justify-center items-center text-center transform transition-all duration-700 hover:scale-105 hover:shadow-xl`}
      >
        <div className="px-8 py-4 space-y-2">
          <h3 className="text-2xl font-bold transform scale-90 animate-fade-in">
            {title}
          </h3>
...
export default function CallSection() {
  return (
    <section
      className={`bg-[${UI_CONSTANTS.colors.background}] font-sans overflow-hidden`}
    >
