      ...
      <Container>
        <div className="bg-[#8B5CF6] text-white rounded-xl shadow-lg p-8 md:p-12 transform transition-all duration-700 hover:scale-105 hover:shadow-xl">
          <div className="flex flex-col items-center text-center">
            <h2 className="text-3xl md:text-4xl font-bold leading-tight mb-6 flex items-baseline justify-center animate-fade-in">
              <Image
                src="/icons/graph.svg"
                alt="Graph icon"
                width={36}
            ...
            <p className="text-lg md:text-xl max-w-3xl leading-relaxed animate-fade-in-delay">
